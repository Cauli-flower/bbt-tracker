...
window.Store = (function () {
   ...
   *     perDay: 2,                  // 一天吃几次（决定每天勾几格）
   *     taken: { "2026-07-28": [0,1] },  // 哪天吃了第几次
   *     affectsTemp: true | false,  // 这个药会不会抬高基础体温（孕激素类会）。勾上之后，
   *                                 //   用药期间（+停药后 2 天）的体温一律标成「不作数」，
   *                                 //   不参与排卵判读，见 cycle.js 的 confoundRanges
